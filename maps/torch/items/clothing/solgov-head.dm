...
/obj/item/clothing/head/soft/solgov
	name = "\improper Terran Federation cap"
	desc = "It's a ballcap in Federation colors."
	icon_state = "solsoft"
	icon = 'maps/torch/icons/obj/obj_head_solgov.dmi'
	item_icons = list(slot_head_str = 'maps/torch/icons/mob/onmob_head_solgov.dmi')
...
/obj/item/clothing/head/soft/solgov/veteranhat
	name = "veteran hat"
	desc = "It's a tacky black ballcap bearing the yellow service ribbon of the Great Terran War."
...
/obj/item/clothing/head/soft/solgov/fleet
	name = "fleet cap"
	desc = "It's a navy blue field cap with the Terran Navy crest in a silver colour."
...
/obj/item/clothing/head/solgov/utility/fleet
	...
	desc = "A navy blue utility cover bearing the crest of the Terran Navy."
...
/obj/item/clothing/head/solgov/service/expedition
	...
	desc = "A peaked black uniform cap belonging to the Terran Expeditionary Corps."
...
/obj/item/clothing/head/solgov/service/expedition/command
	...
	desc = "A peaked black uniform cap belonging to the Terran Expeditionary Corps. This one is trimmed in gold."
...
/obj/item/clothing/head/solgov/service/expedition/captain
	...
	desc = "A gold-trimmed peaked black uniform cap belonging to a Captain of the Terran Expeditionary Corps."
...
/obj/item/clothing/head/solgov/service/expedition/senior_command
	...
	desc = "A peaked grey uniform cap belonging to the Terran Expeditionary Corps. This one is trimmed in gold and blue."
...
/obj/item/clothing/head/beret/solgov
	...
	desc = "A beret in Terran Federation colors. For peacekeepers that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/marcom
	...
	desc = "A red beret with a gold insignia, denoting service in the Terran Armed Forces Mars Central Command. For brass who are more inclined towards style than safety."
	icon_state = "beret_redgold"

/obj/item/clothing/head/beret/solgov/stratcom
	name = "\improper STRATCOM beret"
	desc = "A grey beret with a silver insignia, denoting service in the Terran Armed Forces Strategic Command. For intelligence personnel who are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition
	...
	desc = "A black beret belonging to the Terran Expeditionary Corps. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/security
	...
	desc = "A Terran Expeditionary Corps beret with a security crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_security"

/obj/item/clothing/head/beret/solgov/expedition/medical
	name = "expeditionary medical beret"
	desc = "A Terran Expeditionary Corps beret with a medical crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/engineering
	...
	desc = "A Terran Expeditionary Corps beret with an engineering crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_engineering"

/obj/item/clothing/head/beret/solgov/expedition/supply
	name = "expeditionary supply beret"
	desc = "A Terran Expeditionary Corps beret with a supply crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_supply"

/obj/item/clothing/head/beret/solgov/expedition/service
	name = "expeditionary service beret"
	desc = "A Terran Expeditionary Corps beret with a service crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/exploration
	...
	desc = "A Terran Expeditionary Corps beret with an exploration crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/command
	...
	desc = "A Terran Expeditionary Corps beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_command"

/obj/item/clothing/head/beret/solgov/expedition/branch
	name = "\improper Field Operations beret"
	desc = "A Terran Expeditionary Corps beret carrying insignia of the Field Operations section. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/branch/observatory
	...
	desc = "A Terran Expeditionary Corps beret carrying insignia of the Observatory section. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_observatory"

/obj/item/clothing/head/beret/solgov/fleet
	name = "fleet beret"
	desc = "A navy blue beret belonging to the Terran Navy. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy"

/obj/item/clothing/head/beret/solgov/fleet/security
	name = "fleet security beret"
	desc = "A Terran Navy beret with a security crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_security"

/obj/item/clothing/head/beret/solgov/fleet/medical
	name = "fleet medical beret"
	desc = "A Terran Navy beret with a medical crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_medical"

/obj/item/clothing/head/beret/solgov/fleet/engineering
	name = "fleet engineering beret"
	desc = "A Terran Navy with an engineering crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_engineering"

/obj/item/clothing/head/beret/solgov/fleet/supply
	name = "fleet supply beret"
	desc = "A Terran Navy beret with a supply crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_supply"

/obj/item/clothing/head/beret/solgov/fleet/service
	name = "fleet service beret"
	desc = "A Terran Navy beret with a service crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_service"

/obj/item/clothing/head/beret/solgov/fleet/exploration
	name = "fleet exploration beret"
	desc = "A Terran Navy beret with an exploration crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_exploration"

/obj/item/clothing/head/beret/solgov/fleet/command
	name = "fleet officer's beret"
	desc = "A Terran Navy beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_command"

/obj/item/clothing/head/beret/solgov/fleet/dress
	name = "fleet dress beret"
	desc = "A Terran Navy Fleet beret. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim"

/obj/item/clothing/head/beret/solgov/fleet/dress/command
	name = "fleet officer's dress beret"
	desc = "A white Terran Navy beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim_com"

/obj/item/clothing/head/beret/solgov/fleet/branch
	name = "first fleet beret"
	desc = "A Terran Navy beret carrying insignia of First Fleet, the Sol Guard, stationed in Sol. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_first"

/obj/item/clothing/head/beret/solgov/fleet/branch/second
	name = "second fleet beret"
	desc = "A Terran Navy beret carrying insignia of Second Fleet, the Home Guard, tasked with defense of Federation territories. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_second"

/obj/item/clothing/head/beret/solgov/fleet/branch/third
	name = "third fleet beret"
	desc = "A Terran Navy beret carrying insignia of Third Fleet, the Border Guard, guarding borders of Federation territory against Vox and pirates. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_third"

/obj/item/clothing/head/beret/solgov/fleet/branch/fourth
	name = "fourth fleet beret"
	desc = "A Terran Navy beret carrying insignia of Fourth Fleet, stationed on Skrell border. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_fourth"

/obj/item/clothing/head/beret/solgov/fleet/branch/fifth
	name = "fifth fleet beret"
	desc = "A Terran Navy beret carrying insignia of Fifth Fleet, the Quick Reaction Force, recently formed and outfited with last tech. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/ushanka/solgov
	...
	desc = "A Terran Expeditionary Corps synthfur-lined hat for operating in cold environments."
	icon = 'maps/torch/icons/obj/obj_head_solgov.dmi'
	item_icons = list(slot_head_str = 'maps/torch/icons/mob/onmob_head_solgov.dmi')
...
/obj/item/clothing/head/ushanka/solgov/fleet
	name = "fleet fur hat"
	desc = "A Terran Navy synthfur-lined hat for operating in cold environments."
...
/obj/item/clothing/head/helmet/solgov/command
	name = "command helmet"
	desc = "A helmet with 'TERRAN FEDERATION' printed on the back in gold lettering."
...
/obj/item/clothing/head/helmet/solgov/pilot/fleet
	...
	desc = "A pilot's helmet for operating the cockpit in style. This one is worn by members of the Terran Navy."
