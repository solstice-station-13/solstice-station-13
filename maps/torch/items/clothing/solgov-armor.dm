/obj/item/clothing/suit/armor/vest/solgov
	name = "\improper Terran Federation armored vest"
	desc = "A synthetic armor vest. This one is marked with the crest of the Terran Federation."
	icon_state = "solvest"
	icon = 'maps/torch/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/torch/icons/mob/onmob_suit_solgov.dmi')

/obj/item/clothing/suit/storage/vest/solgov
	name = "\improper Terran Federation heavy armored vest"
...
/obj/item/clothing/suit/storage/vest/solgov/command
	...
	desc = "A synthetic armor vest with TERRAN FEDERATION printed in gold lettering on the chest. This one has added webbing and ballistic plates."
	icon_state = "comwebvest"

/obj/item/clothing/suit/armor/pcarrier/blue/sol
	name = "peacekeeper plate carrier"
	desc = "A lightweight plate carrier vest in Federation Peacekeeper colors. It can be equipped with armor plates, but provides no protection of its own."
