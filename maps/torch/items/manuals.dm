...
/obj/item/weapon/book/manual/sol_sop
	...
	desc = "SOP aboard the TEV Solstice."
...
/obj/item/weapon/folder/envelope/captain
	desc = "A thick envelope. The Terran crest is stamped in the corner, along with 'TOP SECRET - TORCH UMBRA'."
...
/obj/item/weapon/folder/envelope/captain/LateInitialize()
	...
	var/memo = {"
	<tt><center><b><font color='red'>SECRET - CODE WORDS: Solstice</font></b>
	<h3>TERRAN FEDERATION EXPEDITIONARY COMMAND</h3>
	<img src = sollogo.png>
	</center>
	<b>FROM:</b> ADM William Lau<br>
	<b>TO:</b> Commanding Officer of TEV Solstice<br>
	...
	None of these systems are claimed by any entity recognized by the Federation, so you have full salvage rights on any derelicts discovered.<br>
	Investigate and mark any prospective colony worlds as per usual procedures.<br>
	There is no Federation presence in that area. In case of distress calls, you will be the only vessel available; do not ignore them. We cannot afford any more PR backlash.<br>
	...
	<i>ADM Lau.</i></tt>
	<i>This paper has been stamped with the stamp of Terran Federation Expeditionary Command.</i>
	"}
	new/obj/item/weapon/paper(src, memo, "Standing Orders")
	new/obj/item/weapon/paper/umbra(src)

/obj/item/weapon/folder/envelope/rep
	desc = "A thick envelope. The Terran crest is stamped in the corner, along with 'TOP SECRET - SOLSTICE UMBRA'."
...
/obj/item/weapon/paper/umbra
	name = "UMBRA Protocol"
	info = {"
	<tt><center><b><font color='red'>TOP SECRET - CODE WORDS: SOLSTICE UMBRA</font></b>
	<h3>OFFICE OF THE PRESIDENT OF THE TERRAN FEDERATION</h3>
	<img src = sollogo.png>
	</center>
	<b>FROM:</b> Johnathan Smitherson, Special Aide of the Secretary General<br>
	<b>TO:</b> Commanding Officer of the TEV Solstice<br>
	<b>CC:</b> Special Representative aboard the TEV Solstice<br>
	...
	Procedure can be initiated only by transmission from Terran Expeditionary Command via secure channel. The sender may not introduce themselves, but you shouldn't have trouble confirming the transmission source, I believe.<br>
	...
	<li>Information about this expedition's findings is to be treated as secret and vital to the Federation's's national security, and is protected under codeword UMBRA. Only Terran government employees and Skrell citizens aboard the TEV Solstice are allowed access to this information on a need-to-know basis.</li>
	...
	<i>Regards, John.</i></tt>
	<i>This paper has been stamped with the stamp of Office of the President of the Terran Federation.</i>
	"}
