...
/datum/category_group/player_setup_category/solstice
	name = "Genemods"
	sort_order = 9
...
/datum/category_item/player_setup_item/vore/ears/load_character(datum/pref_record_reader/R)
	...
	pref.wing_style    = R.read("wing_style")
...
/datum/category_item/player_setup_item/vore/ears/content(var/href,var/list/href_list, var/mob/user)
	...
	if(ear_styles_list[pref.ear_style])
		var/valid_ears = cspecies.permitted_ears ? cspecies.permitted_ears : ears_styles_list
	...
	if(pref.tail_style && (pref.tail_style in tail_styles_list))
		var/valid_tails = cspecies.permitted_tail ? cspecies.permitted_tail : tail_styles_list
	...
	if(pref.wing_style && (pref.wing_style in wing_styles_list))
		var/valid_wings = cspecies.permitted_wings ? cspecies.permitted_wings : wings_styles_list
