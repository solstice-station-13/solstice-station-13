...
/datum/dna
	...
	// Solstice Station CUSTOM SPECIES
	var/custom_species
	var/base_species = "Custom Human"
	var/list/species_traits = list()
	var/blood_color = "#f5e400"
	// Solstice Station CUSTOM SPECIES END
...
/datum/dna/proc/Clone()
	...
	new_dna.base_species=base_species //Solstice Station Edit
	new_dna.species_traits=species_traits.Copy() //Solstice Station Edit
	new_dna.blood_color=blood_color //Solstice Station Edit
