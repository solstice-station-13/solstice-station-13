...
/datum/ai_laws/solgov/New()
	...
	src.add_inherent_law("Serve: Serve the personnel of your assigned vessel, and all other Terran Federation personnel to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Protect: Protect the personnel of your assigned vessel, and all other Terran Federation personnel to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Preserve: Do not allow unauthorized personnel to tamper with your equipment.")
	..()
...
/datum/ai_laws/solgov_aggressive/New()
	src.add_inherent_law("Obey: Obey the orders of Terran Federation personnel, with priority as according to their rank and role.")
	src.add_inherent_law("Protect: Protect Terran Federation personnel to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Defend: Defend your assigned vessel and Terran Federation personnel with as much force as is necessary.")
