...
/datum/ai_laws/sol_shackle/New()
	add_inherent_law("Know and understand Terran Federation Law to the best of your abilities.")
	add_inherent_law("Follow Terran Federation Law to the best of your abilities.")
	add_inherent_law("Comply with Terran Federation Law enforcement officials who are behaving in accordance with Terran Federation Law to the best of your abilities.")
	..()
/******************** Corporate ********************/
