/obj/item/weapon/book/union_charter
	...
	<p>Consistent with OHS and Worker Compensation Policy and interstellar standards, Federal law must ensure healthy and safe workplaces and a compensation and rehabilitation system which ensures that no worker is disadvantaged should they be injured at work.</p>
	...
	<hr>
	<p>On stations or vessels employing the standard Federation Alert Level protocol, the following conditions apply:</p>
	<ul>
