...
GLOBAL_LIST_INIT(zombie_species, list(\
	...
	SPECIES_AKULA, SPECIES_CUSTOM, SPECIES_OLDUNATHI, SPECIES_SERGAL, SPECIES_TAJ, \
	SPECIES_VASS, SPECIES_VULP
))
...
/datum/reagent/zombie/affect_blood(mob/living/carbon/M, alien, removed)
	...
	M.reagents.add_reagent(/datum/reagent/zombie, RAND_F(0.5, 0.5))
