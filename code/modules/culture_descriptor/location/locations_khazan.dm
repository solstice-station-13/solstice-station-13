/decl/cultural_info/location/khazan
	...
	description = "Cezh’jedihn is a semi-arid Earth-sized planet with no major oceans or seas but high levels of tectonic activity, and some volcanic activity resulting from \
