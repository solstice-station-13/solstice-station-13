/datum/codex_entry/cuchulain_foundation
	...
	of private parties, the Federation, and their own interests. They are also the single largest psionic registration \
	...
	bodies like the Federation are unclear."
...
/datum/codex_entry/psionics
	...
	A decade of study has resulted in the Federation determining that these psionics, mild as they are, don't pose \
